...
export default class Gun {
    ...
    findRowPositions(rowIndex: number, colIndex: number, positions: number[][], board: BoardType) {
    ...
    findColPositions(rowIndex: number, colIndex: number, positions: number[][], board: BoardType) {
    ...
    killRule(position: number[], board: BoardType) {
        const positions = [];
    ...
    getDisturb(position: number[], targetPosition: number[], board: BoardType) {
        const positions = [];
